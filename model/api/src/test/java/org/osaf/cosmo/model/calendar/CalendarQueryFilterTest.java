...
public class CalendarQueryFilterTest extends TestCase {
    protected String baseDir = "/queries";
    ...
    protected Element parseFile(String file) throws Exception{
        DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
        dbf.setNamespaceAware(true);
        DocumentBuilder db = dbf.newDocumentBuilder();
        InputStream resource = getClass().getResourceAsStream(baseDir + file);
        if (resource == null) {
            throw new IllegalArgumentException("Resource " + baseDir + file + " doesn't exist");
        }
