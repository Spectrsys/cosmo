 ...
 */
package org.osaf.cosmo.model.calendar.data;
...
import org.osaf.cosmo.model.calendar.OutputFilter;
...
public class LimitRecurrenceSetTest extends TestCase {
    ...
    public void testLimitRecurrenceSet() throws Exception {
        ...
        InputStream fis = getClass().getResourceAsStream("/limit_recurr_test.ics");
    ...
    public void testLimitFloatingRecurrenceSet() throws Exception {
        CalendarBuilder cb = new CalendarBuilder();
        InputStream fis = getClass().getResourceAsStream("/limit_recurr_float_test.ics");
        Calendar calendar = cb.build(fis);
    ...
    public void testLimitRecurrenceSetThisAndFuture() throws Exception {
        CalendarBuilder cb = new CalendarBuilder();
        InputStream fis = getClass().getResourceAsStream("/limit_recurr_taf_test.ics");
        Calendar calendar = cb.build(fis);
