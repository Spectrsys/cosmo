 ...
 */
package org.osaf.cosmo.model.eim.schema;
...
public class EimValueConverter implements EimSchemaConstants {
        ...
        if (text != null) {
            for (String s : text.split(":")) {
                try {
                    ...
                    throw new IllegalArgumentException("Invalid iCalendar recurrence rule " + s);
                }
            }
        }
        return recurs;
    ...
    public static ICalDate toICalDate(String text)
        ...
        try {
            ...
            throw new IllegalArgumentException("Invalid date value " + text, e);
        } catch (UnknownTimeZoneException e) {
            throw new IllegalArgumentException("Unknown timezone " + e.getMessage(), e);
        }
    }
    ...
    public static Trigger toIcalTrigger(String text)
        ...
        try {
            ...
            throw new IllegalArgumentException("invalid trigger: " + text);
        }
