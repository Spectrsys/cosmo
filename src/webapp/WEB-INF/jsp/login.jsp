...
<html:link page="${forgotUrl}" onclick="popup('${forgotUrl}', 'forgot', 'resizable=yes,width=480,height=200,left=40,screenx=40,top=20,screeny=20,scrollbars'); return false"><fmt:message key="Login.Forgot"/></html:link>
</div>
