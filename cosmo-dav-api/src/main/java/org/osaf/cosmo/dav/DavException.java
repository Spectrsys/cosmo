...
public class DavException extends org.apache.jackrabbit.webdav.DavException {
    ...
    protected void writeContent(XMLStreamWriter writer)
        throws XMLStreamException {
        writer.writeStartElement(ExtendedDavConstants.NS_COSMO, "internal-server-error");
        if (getMessage() != null)
    ...
    public static class DavNamespaceContext implements NamespaceContext {
        ...
        public DavNamespaceContext() {
            ...
            uris.put("D", "DAV:");
            uris.put(ExtendedDavConstants.PRE_COSMO, ExtendedDavConstants.NS_COSMO);
            ...
            cosmo.add(ExtendedDavConstants.PRE_COSMO);
            prefixes.put(ExtendedDavConstants.NS_COSMO, cosmo);
        }
