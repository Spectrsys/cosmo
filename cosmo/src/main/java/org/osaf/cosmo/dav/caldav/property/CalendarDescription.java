...
public class CalendarDescription extends AbstractDavProperty
    ...
    public Element toXml(Document document) {
        // have to override the superclass method since we need to add
        // an attribute to the element generated by it
        Element elem = super.toXml(document);
        DomUtil.setAttribute(elem, XML_LANG, NAMESPACE_XML, language);
        return elem;
    }
