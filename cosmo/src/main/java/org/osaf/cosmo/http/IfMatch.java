...
public class IfMatch {
    private static final Log log = LogFactory.getLog(IfMatch.class);
     ...
     * the resource, then the server MAY perform the requested
     * method.
     * </p>
     * <p>
     * If <code>*</code> is given and no current entity exists, the
     * server MUST NOT perform the requested method.
     * </p>
     * <p>
     * If any of the entity tags match the entity tag of the entity,
     * then the server MAY perform the requested method.
     * </p>
     * <p>
